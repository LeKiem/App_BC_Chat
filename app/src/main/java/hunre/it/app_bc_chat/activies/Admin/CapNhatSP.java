...
public class CapNhatSP extends AppCompatActivity {
    ...
    private void loadSanPham(String id) {
        ...
        reference.child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String hinhAnh = "" + snapshot.child("picUrl").getValue();
                String tenSp = "" + snapshot.child("title").getValue();
                String price = "" + snapshot.child("price").getValue();
                String giaGoc = "" + snapshot.child("giaGoc").getValue();
                String moTa = "" + snapshot.child("description").getValue();
    ...
    private void capNhatHinhAnh(String id) {
        ...
        progressDialog.show();
        final String timestamp = ""+System.currentTimeMillis();
        String path = "hinh_anh_san_pham/" + "" + id;
