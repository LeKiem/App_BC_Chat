...
public class KnccFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_kncc, container, false);
    }
    @Override
    ...
    private void initList(View view) {
        ...
        DatabaseReference myRef = database.getReference("KNCC");
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    RecyclerView desTxt = view.findViewById(R.id.knccView);
                    if(list.size()>0){
