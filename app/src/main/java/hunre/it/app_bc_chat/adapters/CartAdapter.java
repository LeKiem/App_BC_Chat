...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.binding.feeEachitem.setText( listItemSelected.get(position).getPrice() + ".000đ");
        holder.binding.totalEachItem.setText(Math.round((listItemSelected.get(position).getNumberinCart() * listItemSelected.get(position).getPrice())) + ".000đ");
        holder.binding.numberTxt.setText(String.valueOf(listItemSelected.get(position).getNumberinCart()));
