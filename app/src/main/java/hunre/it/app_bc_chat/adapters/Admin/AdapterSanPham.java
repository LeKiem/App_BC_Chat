...
import hunre.it.app_bc_chat.activies.Admin.CapNhatSP;
...
public class AdapterSanPham extends RecyclerView.Adapter<AdapterSanPham.HolderSanPham> implements Filterable {
    ...
    public ArrayList<SanPham> sanPhams, kqTimKiem;
    ...
    public void onBindViewHolder(@NonNull HolderSanPham holder, int position) {
        ...
        final SanPham modelSanPham = sanPhams.get(position);
        // get
        String title = modelSanPham.getTitle();
        String picUrl = modelSanPham.getPicUrl();
    ...
    private void dialogMonAn(String id, SanPham sanPham) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.CustomAlertDialog);
        // dialog sản phẩm
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_tt_san_pham, null);
        ImageView picUrl = view.findViewById(R.id.hinhAnh);
        TextView title = view.findViewById(R.id.tenSp);
...
//            String tenSanPham = title.getText().toString().trim();
...
//    private void themVaoGio(String ma_sp, String hinh_anh, String co_giam_gia, String ti_le, String ten_sp, String gia_goc, String gia_giam, String soLuongSP, String tongGiaTienSP, String uid) {
//        itemId++;
...
//    }
    ...
    private void xoa(String id) {
        ...
        new AlertDialog.Builder(context, R.style.CustomAlertDialog)
                ...
                .setMessage("Bạn có muốn xóa sp này vĩnh viễn?")
    ...
    protected static class HolderSanPham extends RecyclerView.ViewHolder {
        private final TextView tiLe, title, giaGoc, giamCon;
        ...
        public HolderSanPham(@NonNull View itemView) {
            ...
            picUrl = itemView.findViewById(R.id.hinhAnh);
        }
    }
}
